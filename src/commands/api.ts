...
export default class Api extends Command {
    ...
    protected description =
        'Call a generic API on a specific AlaCrity machine. Use carefully only if you really know what you are doing!'
    ...
    protected options = (params?: IParams): IOption[] => [
        ...
        },
        {
            ...
            env: 'ALACRITY_NAME',
            message: params
                ? 'select the AlaCrity machine name you want to call API to'
        ...
        CliHelper.get().getEnsureAuthenticationOption(
            ...
            async (machine: IMachine) => {
                ...
                try {
                    await CliApiManager.get(machine).getAlacranInfo()
                } catch (e) {
    ...
    protected async preAction(
        ...
        StdOutUtil.printMessage(
            'Call generic AlaCrity API [Experimental Feature]...\n'
        )
